...
const AdminQuestions = () => {
  ...
  const fetchQuestions = async () => {
    try {
      setLoading(true);
      const response = await fetch(`https://clubportal-3s4b.onrender.com/questions/iste/${sig}/get`, {
        method: 'GET',
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const settingsResponse = await fetch(`https://clubportal-3s4b.onrender.com/questions/iste/${sig}/settings`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${userData.token}`
      ...
      const response = await fetch(`https://clubportal-3s4b.onrender.com/questions/iste/${sig}/add`, {
        method: "POST",
        headers: { 
          "Content-Type": "application/json",
          "Authorization": `Bearer ${userData.token}`
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this question?")) {
      try {
        const response = await fetch(`https://clubportal-3s4b.onrender.com/questions/iste/${sig}/delete/${id}`, {
          method: "DELETE",
          headers: {
            'Authorization': `Bearer ${userData.token}`
          }
  ...
  const updateMarks = async () => {
    try {
      const response = await fetch(`https://clubportal-3s4b.onrender.com/questions/iste/${sig}/updateMarks/${editMarks.id}`, {
        method: "PATCH",
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${userData.token}`
